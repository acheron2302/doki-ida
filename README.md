...
> Status: early (v0.1.0). Bundles 3 characters (Rem, Zero Two — sakura/obsidian)
> as a working set; more can be added by dropping in definitions + stickers.
...
3. Re-run `tools\deploy.ps1`. The new character appears in the picker.
